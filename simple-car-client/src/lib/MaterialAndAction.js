      ...
      if (child.name.includes('Tire')) {
        switch (child.name) {
          ...
          case 'Tire_19':
            ...
            let webglContext = renderer.getContext('webgl')
...
//The Cubemap path
var r = getBaseUrl()+'/profile/avatar/2023/12/23/static/data/env/cubemap/'
...
var dfCol_Body = webColorToHex(config.body_colors.colors[2].value)
...
var Tire_A02_s3tc = LoadTextureCorrected(
  mDDSLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_A02-dxt.dds'
)
var Tire_N02_s3tc = LoadTextureCorrected(
  mDDSLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_N02-dxt.dds'
)
var Tire_A02_pvr = LoadTextureCorrected(
  mKTXLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_A02-pvr.ktx'
)
var Tire_N02_pvr = LoadTextureCorrected(
  mKTXLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_N02-pvr.ktx'
)
var Tire_A02_etc1 = LoadTextureCorrected(
  mKTXLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_A02-etc1.ktx'
)
var Tire_N02_etc1 = LoadTextureCorrected(
  mKTXLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_N02-etc1.ktx'
)
...
//   mDDSLoader,
//   getBaseUrl()+'/dev-api/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_AO01-dxt.dds'
// )
// var Tire_AO02 = LoadTextureCorrected(
//   mDDSLoader,
//   getBaseUrl()+'/dev-api/profile/avatar/2023/12/23/static/data/lynkco09/texture/Tire_AO02-dxt.dds'
// )
var Phev_Hub06_AO = LoadTextureCorrected(
  mTextureLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Phev_Hub06_AO.jpg'
)
var Alpha01 = LoadTextureCorrected(
  mDDSLoader,
  getBaseUrl()+'/profile/avatar/2023/12/23/static/data/lynkco09/texture/Alpha01-dxt.dds'
)
